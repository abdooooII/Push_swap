...
#    Updated: 2024/06/26 17:13:26 by abouafso         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = push_swap.c utils.c split.c init_stack.c lists_libft.c rotate.c \
	push.c swap.c reverse.c sort.c algo.c algo_helper.c parsing.c parsing_2.c parsing_3.c parsing_4.c
BONUS_SRC = push_swap_bonus.c utils_bonus.c split_bonus.c init_stack_bonus.c \
	...
	get_next_line_utils_bonus.c parsing_bonus.c parsing_2_bonus.c parsing_3_bonus.c parsing_4_bonus.c
